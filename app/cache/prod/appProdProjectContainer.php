...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ComBundle', ($this->targetDirs[2].'/Resources/ComBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ComBundle', ($this->targetDirs[3].'/src/ComBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0a8ef05c80ea023aa972f34807b975064beada3228d64e22349eeea22c536adb');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('email@example.com' => 'BSLWorkbench Webmaster'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/ComBundle/Resources/translations/messages.pl.yml'), 'pl', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ComBundle/Resources/views'), 'Com');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'email@example.com' => 'BSLWorkbench Webmaster',
            ),
